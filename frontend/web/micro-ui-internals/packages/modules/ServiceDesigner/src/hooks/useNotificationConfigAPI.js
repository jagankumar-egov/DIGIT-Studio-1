...
export const useNotificationConfigAPI = () => {
  ...
  const saveNotificationConfig = useMutation({
    mutationFn: async (notificationData) => {
      ...
      console.log("Existing draft for save:", existingDraft);
      console.log("User info:", Digit.UserService.getUser()?.info);
      ...
      if (existingDraft) {
        ...
        console.log("Update payload for save:", updatePayload);
